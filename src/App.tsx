...
const NOTIFICATION_SOUND_URL = "data:audio/mp3;base64,";
    ...
    >
      <AnimatePresence mode="wait">
        <PageTransition key={activeTab}>
            ...
            {activeTab === 'settings' && <Settings config={config} onConfigChange={handleConfigChange} userRole={userRole} onRoleChange={() => {}} onResetData={() => {}} darkMode={darkMode} />}
        </PageTransition>
      </AnimatePresence>
    </Layout>
  );

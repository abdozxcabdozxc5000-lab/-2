                ...
                <div className="space-y-6">
                    {historyView ? (
                        <>
                            ...
                            <div className="hidden print-overlay print:block print:absolute print:top-0 print:left-0 print:w-full print:bg-white print:z-[99999]">
                                {/* Header */}
                                <div className="text-center pb-4 mb-4 pt-4">
                                    ...
                                    <p className="text-sm text-black">تاريخ التقرير: {new Date().toLocaleDateString('en-CA')}</p>
                                </div>
                                <hr className="border-black mb-6" />

                                {/* Table */}
                                <table className="w-full text-right text-[12px] border-collapse border border-black mb-8 text-black" dir="rtl">
                                    <thead>
                                        <tr className="bg-gray-100">
                                            <th className="p-2 border border-black text-center w-10">#</th>
